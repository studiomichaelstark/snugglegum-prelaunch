...
| On phones (below 768 px) the hero pouch is 25% smaller (`min(75%, 390px)`) and overlaps the giant "GUMMIES" word less. From `md` (768 px) up it is as designed | Requested for the mobile view, so the word behind the pouch is readable |
