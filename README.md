...
| Hero pouch is 25% smaller (`min(75%, 390px)`), and on screens narrower than about 890 px it overlaps the giant "GUMMIES" word less | Requested, so the word behind the pouch is readable. Desktop overlap is unchanged |
